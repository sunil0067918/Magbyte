    ...
    <div className="bg-[#D9D9D9] py-[40px] flex justify-center">
      <div className="lg:w-[80%] flex  flex-col  items-center">
        <div className="flex flex-col justify-center items-center text-center">
          <span className="lg:text-[32px] text-[20px] font-[500]  lg:font-[700]  text-center flex ">
            Service We Provide
          </span>
        ...
        <div className="flex flex-col gap-6 lg:py-20 px-[15px] py-10 lg:px-[30px]">
          <div className="flex  gap-9 flex-col lg:flex-row">
            <div className=" bg-white  lg:px-[30px] px-[15px] py-[20px] lg:py-[40px]  space-y-6  w-full rounded-[5px]     ">
            ...
            <div className=" bg-white   lg:px-[30px] px-[15px] py-[20px] lg:py-[40px]  space-y-4  w-full rounded-[5px]    ">
              <div className="flex flex-col">
