      ...
      <div className=" py-7 flex justify-center mt-20">
        <div className=" w-[90%] lg:w-[80%]">
          ...
          <div className=" py-10 space-y-10 ">
            <div className="border-[1px] hover:border-[#4687C7] sm:px-[20px] sm:py-[15px] px-[10px] py-[7px] hover:text-[#4687C7] text-[#565656] border-[#C1BFBF] rounded-[17px]">
              <div className="   flex justify-between  ">
                <span className="sm:text-[18px]  text-[12px] font-[400] sm:font-[500]">
              ...
              <p
                ...
                }  text-[10px]  font-[200]  sm:text-[15px] sm:font-[300] pt-5`}
              >
            ...
            <div className="border-[1px] hover:border-[#4687C7] hover:text-[#4687C7] sm:px-[20px] sm:py-[15px] px-[10px] py-[7px] text-[#565656] border-[#C1BFBF] rounded-[17px]">
              <div className="  flex justify-between  ">
                <span className="sm:text-[18px]  text-[12px] font-[400] sm:font-[500]">
            ...
            <div className="border-[1px] hover:border-[#4687C7] hover:text-[#4687C7] sm:px-[20px] sm:py-[15px] px-[8px] py-[7px] text-[#565656] border-[#C1BFBF] rounded-[17px]">
              <div className="  flex justify-between  ">
                <span className="sm:text-[18px]  text-[12px] font-[400] sm:font-[500]">
