...
import img from "../../CMS/Joomla/Joomlasectionsimages/images.png";
import img1 from "../Joomla/Joomlasectionsimages/images1.png";
const Joomlasection = () => {
  return (
    <div className="">
      <div className="flex justify-center px-3 bg-slate-200 py-4">
        <div className="lg:w-[90%] flex gap-6 items-center lg:flex-row flex-col  justify-start">
          <div className=" flex flex-col gap-5 items-start">
            <span className="text-[24px] font-[600]">Why Joomla?</span>
            <p className="lg:text-[18px] text-[14px] ">
              Since its first release in 2005, hundreds of developers have
              contributed to improving Joomla!. This collective effort has made
              Joomla! widely popular, user-friendly, stable, and secure.
            </p>
            <p className="lg:text-[18px] text-[14px] ">
              Joomla! has thousands of free extensions and templates allowing
              you to customize your site to fit your specific needs.
            </p>{" "}
            <button className="lg:px-5 lg:py-4 px-3 py-2 bg-red-500 rounded-lg text-white hover:scale-105">
              Learn more about Joomla! 5
            </button>
          </div>
          <img alt="" src={img} className="w-[1000px]" />
        </div>
      </div>
            ...
            <div className="lg:w-[90%] flex flex-col gap-8 lg:gap-12 ">
              <div className="flex lg:flex-row flex-col gap-10 cursor-pointer">
                <div className="border shadow-md flex flex-col gap-3 lg:px-3 bg-white lg:py-3 px-2 p-2 hover:scale-105 hover:duration-300 hover:transition-all lg:w-[600px]  rounded-md   ">
                  ...
                  <p className="lg:text-[16px] text-[13px]  font-[400] text-gray-700">
                    Bespoke Joomla development involves creating tailored
                    solutions using the Joomla content management system (CMS)
                    to meet specific business or project needs. It focuses on
                    customizing the platform's features, design, and
                    functionality to align with the unique requirements of the
                    client. This approach ensures a personalized website or
                ...
                <div className="border shadow-md flex flex-col gap-3 bg-white lg:px-3 lg:py-3 px-2 p-2 hover:scale-105 hover:duration-300 hover:transition-all lg:w-[600px]  rounded-md   ">
                  ...
                  <p className="lg:text-[16px] text-[13px]  font-[400] text-gray-700">
                    Our designs guarantee a seamless user experience across all
                    devices and screen sizes, ensuring smooth navigation and
                    optimal performance on mobile, tablet, and desktop. This
                    provides your audience with a consistent and high-quality
              ...
              <div className="flex lg:flex-row flex-col gap-10 cursor-pointer">
                <div className="border shadow-md flex flex-col gap-3 bg-white lg:px-3 lg:py-3 px-2 p-2 hover:scale-105 hover:duration-300 hover:transition-all lg:w-[600px]  rounded-md   ">
                  ...
                  <p className="lg:text-[16px] text-[13px]  font-[400] text-gray-700">
                    ...
                    Mobile-First and Responsive Design: Ensuring a seamless user
                    experience across all devices, our designs prioritize mobile
                    optimization while adapting flawlessly to tablet and desktop
                    screens for consistent performance and smooth navigation.
                  </p>
                </div>
                ...
                <div className="border shadow-md flex flex-col gap-3 bg-white lg:px-3 lg:py-3 px-2 p-2 hover:scale-105 hover:duration-300 hover:transition-all lg:w-[600px]  rounded-md   ">
                  ...
                  <p className="lg:text-[16px] text-[13px]  font-[400] text-gray-700">
                    Our SEO strategies boost your site’s search engine rankings
                    and online visibility, driving more traffic and improving
                    discoverability. By optimizing your content and structure,
                    we help your site stand out in search results, attracting a
                    broader audience.
                  </p>
                </div>
              </div>
              ...
              <div className="flex lg:flex-row flex-col gap-10 cursor-pointer">
                <div className="border shadow-md flex flex-col gap-3 bg-white lg:px-3 lg:py-3 px-2 p-2 hover:scale-105 hover:duration-300 hover:transition-all lg:w-[600px]  rounded-md   ">
                  ...
                  <p className="lg:text-[16px] text-[13px]  font-[400] text-gray-700">
                    We enhance site speed and efficiency to provide an
                    outstanding user experience, optimizing performance for
                    faster load times and smoother navigation. Our approach
                    ensures a responsive, seamless interaction, keeping visitors
                ...
                <div className="border shadow-md flex flex-col gap-3 bg-white lg:px-3 lg:py-3 px-2 p-2 hover:scale-105 hover:duration-300 hover:transition-all lg:w-[600px]  rounded-md   ">
                  ...
                  <p className="lg:text-[16px] text-[13px]   font-[400] text-gray-700">
                    We offer continuous care and technical support to keep your
                    site running smoothly and efficiently. Our dedicated team
                    manages updates, maintenance, and troubleshooting, so you
                    can focus on your business while we handle all your
                    website’s needs.
                  </p>
                </div>
              </div>
      ...
      <div className="flex justify-center  py-5  px-3 lg:py-10">
        <div className="lg:w-[90%] lg:flex-row flex-col flex gap-20  ">
          <div className="lg:w-[700px] flex flex-col gap-5">
            <span className="lg:text-[36px] text-[20px] font-[500] lg:text-start text-center">
              Leading-edge Joomla Development Company
            </span>
         <div className="flex flex-col gap-7 text-[12px] lg:text-[18px] text-gray-600">
         <p className="">
              Take advantage of a wide range of extensions to enhance your
              online store with the desired features and functionalities through
              Joomla web design and development.
            </p>
            <p>
              Create and launch tailored Joomla website development services,
              leveraging the open-source framework to maintain a sharp focus on
              user convenience and experience through expert object-oriented
              programming.
            </p>
            <p>
              Ensure maximum feasibility, ease of use, and authenticity when
              publishing content online. Achieve efficient content and business
              process management for your enterprise with Joomla development,
              adhering to the best content management practices throughout your
              project.
            </p>
            <p>
              Explore a wide array of customizable Joomla website development
              solutions, including theme customization, component development,
              application development, and custom plugin creation.
            </p>
         </div>
          </div>
