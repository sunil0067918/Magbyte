        ...
        <div className="lg:w-[80%] px-3">
            ...
            <div className="border border-gray-300 bg-gray-50 lg:px-5 lg:py-2 px-2 rounded-md flex-col space-y-8 shadow-md">
              ...
              >
                <span className="text-gray-800 lg:text-[16px] text-[14px] font-semibold">
                  What types of applications can you develop using .NET?
                </span>
                <FontAwesomeIcon
              ...
              >
                <p className="text-gray-600 md:text-[16px] text-[12px]">
                  With .NET, we create a variety of applications, such as web
                  apps, desktop software, mobile applications, and enterprise
                  solutions.
                </p>
              </div>
            </div>
          ...
          <div className="pt-10">
            <div className="border border-gray-300 bg-gray-50 lg:px-5 lg:py-2 px-2 rounded-md flex-col space-y-8 shadow-md">
              ...
              >
                <span className="text-gray-800 lg:text-[16px] text-[14px] font-semibold">
                  Can Magbytes assist with modernizing legacy .NET applications?
                </span>
                <FontAwesomeIcon
              ...
              >
                <p className="text-gray-600 md:text-[16px] text-[12px]">
                  Yes, we can assist in modernizing your legacy .NET
                  applications to enhance performance, security, and
                  maintainability.
                </p>
              </div>
            </div>
          ...
          <div className="pt-10">
            <div className="border border-gray-300 bg-gray-50 lg:px-5 lg:py-2 px-2 rounded-md flex-col space-y-8 shadow-md">
              ...
              >
                <span className="text-gray-800 lg:text-[16px] text-[14px] font-semibold">
                  Do you offer support and maintenance for .NET applications?
                </span>
                <FontAwesomeIcon
              ...
              >
                <p className="text-gray-600 md:text-[16px] text-[12px]">
                  Definitely. We provide continuous support and maintenance to
                  keep your .NET applications running smoothly and up-to-date.
                </p>
              </div>
            </div>
          </div>
          <div className="pt-10">
            <div className="border border-gray-300 bg-gray-50 lg:px-5 lg:py-2 px-2 rounded-md flex-col space-y-8 shadow-md">
              ...
              >
                <span className="text-gray-800 lg:text-[16px] text-[14px] font-semibold">
                  How do you guarantee the quality of .NET applications?
                </span>
                <FontAwesomeIcon
              ...
              >
                <p className="text-gray-600 md:text-[16px] text-[12px]">
                  We adhere to a rigorous quality assurance process that
                  involves comprehensive testing, code reviews, and the
