            ...
            <div className="lg:w-[90%] flex flex-col gap-8 lg:gap-12 ">
              <div className="flex lg:flex-row flex-col gap-10 cursor-pointer">
                <div className="border border-black shadow-xl  flex flex-col gap-3  lg:px-3 lg:py-3 px-2 p-2 hover:scale-105 hover:duration-300 hover:transition-all lg:w-[600px]  rounded-md   ">
                  ...
                  <p className="lg:text-[16px]  text-[12px] text-gray-800 leading-relaxed max-w-prose">
                    Environment management involves the configuration,
                    monitoring, and maintenance of all environments within a
                    development lifecycle. It ensures that the right
                    infrastructure is in place for development, testing,
                    staging, and production. By effectively managing these
                    environments, teams can streamline deployment processes,
                    reduce risks, and enhance the overall efficiency of the
                    DevOps pipeline
                  </p>
                </div>
                <div className="border border-black shadow-xl  flex flex-col gap-3   lg:px-3 lg:py-3 px-2 p-2 hover:scale-105 hover:duration-300 hover:transition-all lg:w-[600px]  rounded-md   ">
                  ...
                  <p className="lg:text-[16px]  text-[12px] text-gray-800 leading-relaxed max-w-prose">
                    "DevOps tooling refers to the suite of software tools and
                    technologies used to automate, integrate, and streamline the
                    various stages of the software development lifecycle. These
                    tools assist in tasks like continuous integration,
                    continuous delivery, monitoring, and collaboration, enabling
                    teams to work more efficiently and deliver high-quality
                    products faste
                  </p>
                </div>
              </div>
              ...
              <div className="flex lg:flex-row flex-col gap-10 cursor-pointer">
                <div className="border border-black shadow-xl  flex flex-col gap-3 lg:px-3 lg:py-3 px-2 p-2 hover:scale-105 hover:duration-300 hover:transition-all lg:w-[600px]  rounded-md   ">
                  ...
                  <p className="lg:text-[16px]  text-[12px] text-gray-800 leading-relaxed max-w-prose">
                    Security integration, also known as DevSecOps, is the
                    practice of embedding security into every phase of the
                    software development lifecycle. By integrating security
                    measures early in the development process, teams can
                    proactively identify and address vulnerabilities, rather
                    than dealing with security concerns at the end
                  </p>
                </div>
                ...
                <div className="border border-black shadow-xl  flex flex-col gap-3  lg:px-3 lg:py-3 px-2 p-2 hover:scale-105 hover:duration-300 hover:transition-all lg:w-[600px]  rounded-md   ">
                  ...
                  <span className="lg:text-[20px] text-[16px] font-[500] text-blue-600">
                    Ongoing Release and Deployment
                  </span>
                  <p className="lg:text-[16px]  text-[12px] text-gray-800 leading-relaxed max-w-prose">
                    Ongoing release and deployment refer to the continuous
                    process of delivering software updates and new features to
                    production in a seamless and automated manner. By adopting
                    this approach, teams can ensure that new code changes are
                    released quickly,
                  </p>
                </div>
              </div>
              ...
              <div className="flex lg:flex-row flex-col gap-10 cursor-pointer">
                <div className="border border-black shadow-xl  flex flex-col gap-3  lg:px-3 lg:py-3 px-2 p-2 hover:scale-105 hover:duration-300 hover:transition-all lg:w-[600px]  rounded-md   ">
                  ...
                  <p className="lg:text-[16px]  text-[12px] text-gray-800 leading-relaxed max-w-prose">
                    Cloud infrastructure management involves overseeing and
                    optimizing cloud resources and services to ensure their
                    efficient operation, performance, and security. This
                    includes tasks like resource allocation, monitoring,
                    scaling, and cost optimization across various cloud
                    platforms.
                  </p>
                </div>
                ...
                <div className="border border-black shadow-xl  flex flex-col gap-3   lg:px-3 lg:py-3 px-2 p-2 hover:scale-105 hover:duration-300 hover:transition-all lg:w-[600px]  rounded-md   ">
                  ...
                  <span className="lg:text-[20px] text-[16px] font-[500] text-blue-600">
                    Ongoing Integration and Deployment (CI/CD)
                  </span>
                  <p className="lg:text-[16px]  text-[12px] text-gray-800 leading-relaxed max-w-prose">
                    Ongoing integration and deployment (CI/CD) is the practice
                    of automating the process of integrating code changes,
                    testing them, and delivering them to production quickly and
                    reliably. Continuous Integration (CI) focuses on
                    automatically merging code changes from multiple
