...
import img from "../ZOHO/Zohosectionimage/images.png";
import img1 from "./Zohosectionimage/image2.png";
const Zohosection = () => {
  return (
    <div>
      <div className="py-10 px-5 flex justify-center items-center  ">
        <div className="flex flex-col lg:w-[90%]">
          <div className="flex flex-col items-center gap-3">
            <span className="lg:text-4xl text-[16px] text-red-600 font-[600] text-center">
              Our Full Range of Zoho Services for Scalable Growth
            </span>
            <span className="lg:text-[18px] text-[14px] text-gray-700 font-[500] text-center">
              We offer comprehensive Zoho services designed to drive scalable
              growth for your business. From implementation and customization to
              ongoing support, we help you optimize Zoho's suite of tools to
            ...
            <div className="lg:w-[90%] flex flex-col gap-8 lg:gap-12 ">
              <div className="flex lg:flex-row flex-col gap-10 cursor-pointer">
                <div className="border shadow-md flex flex-col gap-3 lg:px-3 bg-white lg:py-3 px-2 p-2 hover:scale-105 hover:duration-300 hover:transition-all lg:w-[600px]  rounded-md   ">
                  ...
                  <span className="lg:text-[20px] text-[16px] font-[500] text-red-900">
                    CRM Personalization
                  </span>
                  <p className="lg:text-[16px] text-[13px]  font-[400] text-gray-700">
                    We provide expert CRM personalization services to tailor the
                    system to fit your specific business requirements. Our team
                    customizes features like workflows, dashboards, and
                    reporting tools to ensure seamless integration with your
                    processes, allowing you to enhance customer relationship
                ...
                <div className="border shadow-md flex flex-col gap-3 bg-white lg:px-3 lg:py-3 px-2 p-2 hover:scale-105 hover:duration-300 hover:transition-all lg:w-[600px]  rounded-md   ">
                  ...
                  <p className="lg:text-[16px] text-[13px]  font-[400] text-gray-700">
                    We specialize in Creator app development, building custom
                    applications that are tailored to your business needs. Our
                    team works with you to design, develop, and deploy powerful
                    apps that streamline workflows, enhance productivity, and
                    provide unique solutions for your business challenges.
                  </p>
                </div>
              </div>
              ...
              <div className="flex lg:flex-row flex-col gap-10 cursor-pointer">
                <div className="border shadow-md flex flex-col gap-3 bg-white lg:px-3 lg:py-3 px-2 p-2 hover:scale-105 hover:duration-300 hover:transition-all lg:w-[600px]  rounded-md   ">
                  ...
                  <p className="lg:text-[16px] text-[13px]  font-[400] text-gray-700">
                    Our data migration services ensure a seamless transition
                    from your current system to a new platform. We handle
                    everything from planning and execution to data mapping and
                    validation, ensuring that all your valuable information is
                    accurately and securely transferred without any disruption
                ...
                <div className="border shadow-md flex flex-col gap-3 bg-white lg:px-3 lg:py-3 px-2 p-2 hover:scale-105 hover:duration-300 hover:transition-all lg:w-[600px]  rounded-md   ">
                  ...
                  <p className="lg:text-[16px] text-[13px]  font-[400] text-gray-700">
                    We specialize in custom website development, creating
                    responsive, user-friendly websites tailored to your business
                    needs. Our team focuses on delivering a seamless user
                    experience, integrating the latest technologies and design
                    trends, ensuring your website is not only visually appealing
                    but also optimized for performance and conversion.
                  </p>
                </div>
              </div>
            </div>
      ...
      <div className=" flex justify-center lg:py-16 py-6 ">
        <div className="lg:w-[80%] flex lg:flex-row flex-col items-center gap-10 px-2 ">
          <div className="flex flex-col lg:items-start items-center gap-8">
            <span className=" lg:text-[28px]  text-[18px] font-[600]  text-center ">
              Transform Your Operations with Customized Zoho CRM Automation
              Solutions.
            </span>
            <button className="lg:text-[18px] text-[16px] py-3 px-3 bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-md hover:scale-105 ">
              Hire Zoho Devlopers now!
            </button>
          </div>
          <img alt="" src={img} className="w-[600px] rounded-md" />
        </div>
      </div>
      <div className=" flex justify-center py-10 bg-slate-200  ">
        <div className="lg:w-[90%] flex flex-col gap-10 px-2">
          <span className="text-center lg:text-[28px] text-[18px] font-[600]">
            Connect Zoho CRM with 800+ Apps for Seamless Integration.
          </span>
          <div className=" flex gap-10  lg:flex-row flex-col   ">
            <img src={img1} alt="" className="lg:w-[1000px] lg:h-[400px]" />
            <div className=" flex gap-5 flex-col">
              <div className=" flex flex-col gap-3">
                <span className="lg:text-[22px] text-[16px]  font-[600] ">
                  Zoho Analytics
                </span>
                <p className="lg:text-[16px] text-[12px] text-gray-700">
                  Zoho Analytics offers powerful data analysis and reporting
                  tools that help you turn raw data into actionable insights.
                  With customizable dashboards, real-time reporting, and
                  advanced analytics, it enables you to make informed decisions,
                  track key metrics, and optimize business performance
                  efficiently.
                </p>
              </div>
              ...
              <div className=" flex flex-col gap-3">
                ...
                <p className="lg:text-[16px] text-[12px] text-gray-700">
                  We provide seamless integration of G Suite/Gmail with your
                  business tools, enhancing collaboration and communication. By
                  syncing Gmail with your CRM, calendar, and other productivity
                  apps, we help streamline workflows, improve team efficiency,
                  and ensure smooth operations across your organization.
                </p>
              </div>
              ...
              <div className="  flex flex-col gap-3">
                ...
                <p className="lg:text-[16px] text-[12px] text-gray-700">
                  We offer seamless Slack integration to enhance communication
                  and collaboration within your team. By connecting Slack with
                  your CRM and other business tools, we streamline workflows,
                  improve real-time messaging, and ensure that important updates
                  and notifications are delivered directly to your channels for
                  better productivity.
                </p>
              </div>
              ...
              <div className="  flex flex-col gap-3">
                ...
                <p className="lg:text-[16px] text-[12px] text-gray-700">
                  We provide seamless integration of Office 365/Outlook with
                  your business systems to enhance productivity and
                  communication. By syncing Outlook with your CRM, calendar, and
                  other essential tools, we ensure smooth workflows, easy
                  scheduling, and better management of emails and appointments
