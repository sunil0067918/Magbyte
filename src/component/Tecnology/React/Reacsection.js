...
const Reacsection = () => {
  return (
    <div className="py-10 px-5 flex justify-center items-center bg-[#F5F5F5]">
      <div className="flex flex-col lg:w-[90%]">
        <div className="flex flex-col items-center gap-3">
          <span className="lg:text-4xl text-[16px] font-[600] text-center">
          ...
          <div className="lg:w-[90%] flex flex-col gap-8 lg:gap-12 ">
            <div className="flex lg:flex-row flex-col gap-10 cursor-pointer">
              <div className="border shadow-md flex flex-col gap-3 lg:px-3 bg-white lg:py-3 px-2 p-2 hover:scale-105 hover:duration-300 hover:transition-all lg:w-[600px]  rounded-md   ">
                ...
                <span className="lg:text-[20px] text-[16px] font-[500] text-blue-900">
                  Tailored ReactJS Application Development
                </span>
                <p className="lg:text-[16px] text-[13px]  font-[400] text-gray-700">
                  We create customized ReactJS applications that are perfectly
                  aligned with your unique business needs and goals. Our skilled
                  developers harness the full capabilities of ReactJS to build
              ...
              <div className="border shadow-md flex flex-col gap-3 bg-white lg:px-3 lg:py-3 px-2 p-2 hover:scale-105 hover:duration-300 hover:transition-all lg:w-[600px]  rounded-md   ">
                ...
                <p className="lg:text-[16px] text-[13px]  font-[400] text-gray-700">
                  Design and develop intuitive, user-friendly interfaces that
                  enhance user experience. We focus on creating visually
                  appealing designs that ensure seamless navigation and
                  engagement.
                </p>
              </div>
            </div>
            ...
            <div className="flex lg:flex-row flex-col gap-10 cursor-pointer">
              <div className="border shadow-md flex flex-col gap-3 bg-white lg:px-3 lg:py-3 px-2 p-2 hover:scale-105 hover:duration-300 hover:transition-all lg:w-[600px]  rounded-md   ">
                ...
                <p className="lg:text-[16px] text-[13px]  font-[400] text-gray-700">
                  Develop reusable and maintainable React components that
                  seamlessly integrate into different sections of your
                  application. This modular approach enhances code efficiency
                  and scalability.
                </p>
              </div>
              ...
              <div className="border shadow-md flex flex-col gap-3 bg-white lg:px-3 lg:py-3 px-2 p-2 hover:scale-105 hover:duration-300 hover:transition-all lg:w-[600px]  rounded-md   ">
                ...
                <p className="lg:text-[16px] text-[13px]  font-[400] text-gray-700">
                  ...
                  version. Our team guarantees a smooth transition with minimal
            ...
            <div className="flex lg:flex-row flex-col gap-10 cursor-pointer">
              <div className="border shadow-md flex flex-col gap-3 bg-white lg:px-3 lg:py-3 px-2 p-2 hover:scale-105 hover:duration-300 hover:transition-all lg:w-[600px]  rounded-md   ">
                ...
                <p className="lg:text-[16px] text-[13px]  font-[400] text-gray-700">
                  Integrate third-party APIs and services into your ReactJS
                  applications to enhance functionality and optimize
                  performance. We ensure smooth data flow and seamless
                  interaction between your app and external services.
                </p>
              </div>
              ...
              <div className="border shadow-md flex flex-col gap-3 bg-white lg:px-3 lg:py-3 px-2 p-2 hover:scale-105 hover:duration-300 hover:transition-all lg:w-[600px]  rounded-md   ">
                ...
                <p className="lg:text-[16px] text-[13px]   font-[400] text-gray-700">
                  Implement powerful state management solutions with tools like
                  Redux, MobX, or React Context to manage complex state needs
            ...
            <div className="flex lg:flex-row flex-col gap-10 cursor-pointer">
              <div className="border shadow-md flex flex-col gap-3 bg-white lg:px-3 lg:py-3 px-2 p-2 hover:scale-105 hover:duration-300 hover:transition-all lg:w-[600px]  rounded-md   ">
                ...
                <p className="lg:text-[16px] text-[13px]   font-[400] text-gray-700">
                  Optimize ReactJS applications for improved performance,
                  including faster load times and enhanced responsiveness. We
                  utilize techniques such as code splitting, lazy loading, and
                  efficient rendering to deliver a better user experience.
                </p>
              </div>
              ...
              <div className="border shadow-md flex flex-col gap-3 bg-white lg:px-3 lg:py-3 px-2 p-2  hover:scale-105 hover:duration-300  lg:w-[600px]  rounded-md   ">
                ...
                <p className="lg:text-[16px] text-[13px] font-[400] text-gray-700">
                  Perform thorough testing and quality assurance to identify and
                  fix bugs, ensure application stability, and deliver a
                  high-quality end product. Our testing process covers unit
