...
import img from "../../Ecomar/Bigcommarce/Bigcommsectionimages/images.png";
const Bigcommarcesection = () => {
  return (
    <div>
      <div className="py-10 px-5 flex justify-center items-center  ">
        <div className="flex flex-col lg:w-[90%]">
          <div className="flex flex-col items-center gap-3">
            <span className="lg:text-4xl text-[16px] text-purple-900 font-[600] text-center">
              Big commarce Development Solutions
            </span>
          </div>
            ...
            <div className="lg:w-[90%] flex flex-col gap-8 lg:gap-12 ">
              <div className="flex lg:flex-row flex-col gap-10 cursor-pointer">
                <div className="border shadow-md flex flex-col gap-3 lg:px-3 bg-white lg:py-3 px-2 p-2 hover:scale-105 hover:duration-300 hover:transition-all lg:w-[600px]  rounded-md   ">
                  ...
                  <span className="lg:text-[20px] text-[16px] font-[500] text-purple-900">
      ...
      <div className="flex justify-center py-5 px-2 lg:py-10">
        <div className="lg:w-[90%] flex items-center flex-col  lg:flex-row ">
          <div className="flex flex-col  gap-6 '">
            <span className="lg:text-[28px] text-[18px] font-[600] lg:text-start text-center">
              Hire a BigCommerce Developer at Magbyte
            </span>
            <p className="lg:text-[16px] text-[12px] font-[600] text-center ">
              BigCommerce is a SaaS-based, self-hosted platform packed with
              hundreds of features that allow you to design and customize a
              stunning storefront with your preferred features and
              functionality. Whether you're looking to showcase products, manage
              inventory, or streamline your business operations, BigCommerce
              provides the tools you need for success. At Magbyte, our expert
              developers can help you create a tailored BigCommerce store that
              aligns perfectly with your business goals. From theme
              customization and integrations to performance optimization, we
              offer end-to-end solutions to ensure your store is built for
              growth and success.
            </p>
          </div>
      ...
      <div className="flex justify-center bg-purple-900 ">
        <div className="w-[90%] lg:py-20 text-white flex flex-col items-center gap-5 ">
          <span className="lg:text-[28px] text-[20px] font-[600]">
            Collaborate with our team of skilled developers for the development
            of your BigCommerce store.
          </span>
          <button className="lg:text-[18px] text-[16px] py-4 px-4 bg-blue-700 rounded-md hover:scale-105">Talk to Our experts</button>
        </div>
      </div>
    </div>
  );
...
export default Bigcommarcesection;
