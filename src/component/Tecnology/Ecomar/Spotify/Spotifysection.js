  ...
  return (
    <div>
        ...
        <div className="flex flex-col lg:w-[90%]">
          <div className="flex flex-col items-center gap-3">
            <span className="lg:text-4xl text-[16px] text-green-900 font-[600] text-center">
              Spotify Development Solutions
            </span>
            <span className="lg:text-[18px] text-[14px] text-gray-700 font-[500] text-center">
              We specialize in creating highly reliable custom applications,
              seamless third-party integrations, and scalable Shopify Plus
              solutions. Our expertise also extends to API development,
              performance optimization, UX design, and comprehensive store setup
              and customization. Additionally, we offer ongoing maintenance and
              support to ensure your store runs smoothly and efficiently at all
              times.
            </span>
          </div>
            ...
            <div className="lg:w-[90%] flex flex-col gap-8 lg:gap-12 ">
              <div className="flex lg:flex-row flex-col gap-10 cursor-pointer">
                <div className="border shadow-md flex flex-col gap-3 lg:px-3 bg-white lg:py-3 px-2 p-2 hover:scale-105 hover:duration-300 hover:transition-all lg:w-[600px]  rounded-md   ">
                  ...
                  <p className="lg:text-[16px] text-[13px]  font-[400] text-gray-700">
                    We offer seamless payment gateway integration for your
                    WooCommerce store, ensuring secure and efficient
                    transactions for your customers. Whether you prefer
                    widely-used options like PayPal, Stripe, or authorize.net,
                    or require a more customized solution, we can integrate the
                    most suitable payment gateways to meet your business needs.
                    Our expert team ensures that the setup is smooth, payment
                    processes are fast and secure, and your customers enjoy a
                ...
                <div className="border shadow-md flex flex-col gap-3 bg-white lg:px-3 lg:py-3 px-2 p-2 hover:scale-105 hover:duration-300 hover:transition-all lg:w-[600px]  rounded-md   ">
                  ...
                  <p className="lg:text-[16px] text-[13px]  font-[400] text-gray-700">
                    We provide seamless integration for shipping and fulfillment
                    solutions within your WooCommerce store, ensuring smooth and
                    efficient order processing. Whether you're using popular
                    carriers like UPS, FedEx, or DHL, or need a custom shipping
                    provider, we can integrate these systems to automatically
                    calculate shipping costs, track orders, and manage
                    deliveries. Our team also integrates fulfillment services to
                    streamline inventory management and order dispatch, allowing
              ...
              <div className="flex lg:flex-row flex-col gap-10 cursor-pointer">
                <div className="border shadow-md flex flex-col gap-3 bg-white lg:px-3 lg:py-3 px-2 p-2 hover:scale-105 hover:duration-300 hover:transition-all lg:w-[600px]  rounded-md   ">
                  ...
                  <p className="lg:text-[16px] text-[13px]  font-[400] text-gray-700">
                    We specialize in integrating CRM (Customer Relationship
                    Management) and ERP (Enterprise Resource Planning) systems
                    with your WooCommerce store, streamlining your business
                    operations. By connecting your store with CRM tools, we help
                    you manage customer relationships more effectively, automate
                    marketing tasks, and enhance customer service. ERP
                    integration allows for seamless synchronization of
                    inventory, orders, accounting, and other key business
                    functions, ensuring data consistency across all departments
                  </p>
                </div>
                ...
                <div className="border shadow-md flex flex-col gap-3 bg-white lg:px-3 lg:py-3 px-2 p-2 hover:scale-105 hover:duration-300 hover:transition-all lg:w-[600px]  rounded-md   ">
                  ...
                  <p className="lg:text-[16px] text-[13px]  font-[400] text-gray-700">
                    We offer seamless integration of marketing and analytics
                    tools with your WooCommerce store to enhance your business
                    strategy and drive growth. By connecting your store with
                    platforms like Google Analytics, Facebook Pixel, and email
                    marketing services, we help you track customer behavior,
                    monitor sales performance, and optimize marketing campaigns.
                    Our integration solutions enable you to gather valuable
                    insights, segment your audience effectively, and create
                    targeted marketing strategies that increase conversions and
              ...
              <div className="flex lg:flex-row flex-col gap-10 cursor-pointer">
                <div className="border shadow-md flex flex-col gap-3 bg-white lg:px-3 lg:py-3 px-2 p-2 hover:scale-105 hover:duration-300 hover:transition-all lg:w-[600px]  rounded-md   ">
                  ...
                  <p className="lg:text-[16px] text-[13px]  font-[400] text-gray-700">
                    We provide seamless inventory management integration for
                    your WooCommerce store, ensuring real-time tracking and
                    efficient control of stock levels. Whether you’re using
                    popular inventory management systems like TradeGecko, Cin7,
                    or custom solutions, we can integrate them to automatically
                    update stock quantities, manage orders, and prevent
                    overselling. Our integration helps you streamline product
                    management, maintain accurate inventory records, and improve
                ...
                <div className="border shadow-md flex flex-col gap-3 bg-white lg:px-3 lg:py-3 px-2 p-2 hover:scale-105 hover:duration-300 hover:transition-all lg:w-[600px]  rounded-md   ">
                  ...
                  <p className="lg:text-[16px] text-[13px]   font-[400] text-gray-700">
                    We offer seamless integration of social media platforms and
                    online marketplaces with your WooCommerce store, helping you
                    expand your reach and boost sales. By connecting your store
                    to platforms like Facebook, Instagram, Amazon, and eBay, you
                    can sync your product listings, manage inventory, and track
                    orders across multiple channels from one central hub.
                    Additionally, integrating social media tools enables you to
                    leverage social commerce, run targeted ads, and engage with
                    customers directly on platforms they already use.
                  </p>
                </div>
              </div>
            </div>
      ...
      <div className=" flex justify-center py-4 px-2 ">
        <div className="  bg-gradient-to-r from-green-900 to-green-700  py-6 px-3  lg:py-20 gap-5 lg:px-5 lg:w-[90%] flex flex-col items-center text-white rounded-md">
          <span className="lg:text-[28px] text-[18px] font-[600] text-center ">
            Ready to Develop Strong Web Solutions with Spotify?
          </span>
          <p className="lg:text-[18px] text-[12px] text-center ">
            As a top spotify web development company, we create scalable,
            secure, and high-performance web solutions customized to meet your
            business requirements.
          </p>
          <button className=" lg:text-[18px] text-[13px] px-2 py-1 lg:py-4 lg:px-4 rounded-md hover:scale-105  bg-blue-700 ">
            Get in touch with our Spotify experts!
          </button>
        </div>
      </div>

      <div className=" flex justify-center  bg-slate-300 py-4">
        <div className="lg:w-[90%] flex flex-col items-center gap-5 px-2">
          <span className="lg:text-[28px] text-center text-[20px] font-[700]">
            {" "}
            Shopify as an E-commerce Solution
          </span>
          <p className="text-center text-gray-800 lg:text-[16px] text-[14px]">
            At Magbyte, we use Shopify as our primary e-commerce platform
            because it offers a comprehensive, all-in-one solution for building
            and managing online stores. Shopify provides a broad range of tools
            and services that enable us to create, customize, and manage online
            stores seamlessly, without the need for additional software or
            integrations.
          </p>
          <ul className="flex flex-col gap-3 list-disc lg:text-[18px] text-[16px]  font-[600]">
        ...
        <div className="w-[90%] flex flex-col items-center">
          ...
          <div className=" pt-10 flex flex-col gap-5">
            <div className="flex gap-5 lg:flex-row flex-col">
              <div className="lg:py-3 lg:px-5 px-3 py-2 lg:w-[400px] border  border-black rounded-md flex flex-col gap-3">
                <svg
                  width="56"
                  height="56"
                  viewBox="0 0 56 56"
