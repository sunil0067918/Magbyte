...
const Reactsection2 = () => {
  return (
    <div className="">
      ...
      <div className="flex justify-center bg-gradient-to-r from-sky-400 to-sky-700 py-10 text-white">
        <div className="w-[90%] flex flex-col items-center gap-5">
          <span className="lg:text-[28px] text-[18px] font-[600]">How does React Native Work?</span>
          <ul className="flex flex-col text-center lg:text-[18px] text-[12px]  gap-5">
            <li>
              When creating your ideal app with React Native, you have the
              option to use either Safari or Chrome development tools. What sets
              it apart is its flexibility. Developers can write for one
              operating system and easily transfer that expertise to accelerate
              development for the other operating system.
            </li>
            <li>
              In other words, if you’re aiming to build an app for multiple
              platforms, React Native is your shortcut. Want to create an app
              for both Android and iOS? This option will get you there quickly
              and efficiently!
            </li>
            <li>
              Planning to expand into other operating systems in the future? The
              great news is, a significant portion of your code can be reused,
              making it easy to bring your idea to any other platform. No matter
              how ambitious your vision, React Native will help you deliver your
              idea to your users quickly and efficiently!
            </li>
          </ul>
        </div>
      </div>
