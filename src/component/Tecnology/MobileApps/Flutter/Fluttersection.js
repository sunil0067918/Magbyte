...
import img from "../Flutter/Fluttersectionimage/image.png";
  ...
  return (
    <div>
      <div className="py-10 px-5 flex justify-center items-center  ">
        <div className="flex flex-col lg:w-[90%]">
          <div className="flex flex-col items-center gap-3">
            <span className="lg:text-4xl text-[16px] text-blue-500 font-[600] text-center">
              A Leading Flutter Web Development Solution Provider
            </span>
            <span className="lg:text-[18px] text-[14px] text-gray-700 font-[500] text-center">
              We utilize our expertise in Flutter to build a strong and
      ...
      <div className="flex justify-center lg:py-10 py-5 px-2">
        <div className="lg:w-[90%] flex  lg:flex-row flex-col    justify-between gap-10">
          <div className="flex flex-col items-start gap-6 ">
            <span className=" text-[18px]  lg:text-[28px] font-[600] ">
              Hire Flutter Developers
            </span>
            <p className="lg:text-[16px]  text-[12px]">
              To create high-quality mobile apps across platforms, it is
              essential for organizations to have skilled expertise that
              delivers a seamless native experience. Our team of experienced
              Flutter app developers is equipped to build and develop
              feature-rich, scalable mobile apps tailored to your specific
              business needs.
            </p>
            <button className="lg:text-[18px] text-[14px] lg:px-4 lg:py-4 px-2 py-2 bg-blue-500 rounded-md text-white   ">
              Hire Flutter Expert
            </button>
          </div>

          <img alt=" " src={img} className="w-[600px]  lg:h-[400px]" />
        </div>
      </div>
      ...
      <div className="flex justify-center py-10 bg-slate-200 px-3">
        <div className="lg:w-[90%] flex flex-col items-center w-full gap-6">
          <span className="lg:text-[28px] text-[18px] font-[600] text-blue-700 text-center lg:text-start">
            Why Flutter is the ideal choice for building complex mobile apps.
          </span>
          <ul className="flex gap-10  lg:text-[18px]  justify-between w-full  pl-7 lg:pl-0 lg:flex-row flex-col text-[14px] font-[500]  pt-10 list-disc">
            ...
            <li className="flex flex-col gap-5">
              <li>Intelligent architecture</li>
              <li>Seamless integration</li>
              <li>Cross-platform functionality</li>
              <li>Reduced coding</li>
            </li>
          ...
          <button className="lg:text-[18px]  text-[14px] lg:px-4 lg:py-4 bg-gradient-to-r from-sky-600 to-sky-900 hover:scale-105 text-white  rounded-md ">
