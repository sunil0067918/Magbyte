...
import img from "../../MobileApps/Android/Androidsectionimages/images.png";
  ...
  return (
    <div className="">
        ...
        <div className="flex flex-col lg:w-[90%]">
          <div className="flex flex-col items-center gap-3">
            <span className="lg:text-4xl text-[16px] text-green-500 font-[600] text-center">
              A Leading Android Web Development Solution Provider
            </span>
            <span className="lg:text-[18px] text-[14px] text-gray-700 font-[500] text-center">
              We utilize our expertise in Android to build a strong and
      ...
      <div className=" flex justify-center py-5 px-2">
        <div className="lg:w-[90%] flex gap-10 lg:flex-row flex-col items-center">
          <div className="flex flex-col gap-5">
            <span className="lg:text-[28px] text-[18px] font-[600]  lg:text-start text-center ">
              Popular Android Frameworks We Specialize In
            </span>
            <p className="lg:text-[18px] text-[12px] text-center lg:text-start">
              At Magbyte, we excel in a wide range of Android frameworks,
              harnessing their robust features to develop dynamic and
              high-performance mobile applications. Our deep expertise in these
              frameworks enables us to deliver innovative, tailored solutions
              that meet the unique needs of our clients.
            </p>
          </div>

          <img src={img} alt="" className="w-[1000px]" />
        </div>
      </div>
