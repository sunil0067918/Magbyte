...
import img from "../Hiredevlopers/Hiresectionimage/image.png";

const Hiresection = () => {
  return (
    <div className="">
      <div className="flex justify-center py-10">
        <div className="lg:w-[90%] flex flex-col items-center px-2">
          <div className=" flex flex-col items-center gap-5">
            <span className="lg:text-[28px] text-[20px] text-center font-[600] ">
              Why MageBytes is best for you
            </span>
            <span>MageBytes Integrity </span>
          </div>
          <div className=" pt-10 flex flex-col gap-5">
            <div className="flex gap-5 lg:flex-row flex-col">
              <div className="lg:py-3 lg:px-5 px-3 py-2 lg:w-[400px] border  border-blue-500 hover:scale-105 rounded-md flex flex-col gap-3">
                ...
                <p className=" lg:text-[16px]  text-[12px] text-gray-800 leading-relaxed max-w-prose mx-auto ">
                  Our solutions are delivered by highly experienced experts,
                  ensuring seamless two-way communication with the team. We
                  prioritize clarity, collaboration, and excellence, working
              ...
              <div className="lg:py-3 lg:px-5 px-3 py-2 lg:w-[400px] border  border-blue-500 hover:scale-105 rounded-md flex flex-col gap-3">
                ...
                <p className=" lg:text-[16px]  text-[12px] text-gray-800 leading-relaxed max-w-prose mx-auto ">
                  Following our best practices, we keep up with complete
                  transparency across the project and offer source code that is
                  composed for the clients.
                </p>
              </div>
              ...
              <div className="lg:py-3 lg:px-5 px-3 py-2 lg:w-[400px] border  border-blue-500 hover:scale-105 rounded-md flex flex-col gap-3">
                ...
                <p className=" lg:text-[16px]  text-[12px] text-gray-800 leading-relaxed max-w-prose mx-auto ">
                  The projects we undertake are completed within pre-defined
                  timeframes. You can hire a coder and be assured of not missing
                  deadlines.
                </p>
              </div>
            </div>
            <div className="flex gap-5 lg:flex-row flex-col">
              <div className="lg:py-3 lg:px-5 px-3 py-2 lg:w-[400px] border  border-blue-500 hover:scale-105 rounded-md flex flex-col gap-3">
                ...
                <p className=" lg:text-[16px]  text-[12px] text-gray-800 leading-relaxed max-w-prose mx-auto ">
                  Guaranteed confidentiality and security for your task with
                  strict non-disclosure agreements for each client we work for.
                </p>
              </div>
              ...
              <div className="lg:py-3 lg:px-5 px-3 py-2 lg:w-[400px] border  border-blue-500 hover:scale-105 rounded-md flex flex-col gap-3">
                ...
                <p className=" lg:text-[16px]  text-[12px] text-gray-800 leading-relaxed max-w-prose mx-auto ">
                  Our experts are certified in the most recent advancements.
                  This assists them with conveying future-evidence solutions.
                </p>
              </div>
              ...
              <div className="lg:py-3 lg:px-5 px-3 py-2 lg:w-[400px] border  border-blue-500 hover:scale-105 rounded-md flex flex-col gap-3">
                ...
                <p className=" lg:text-[16px]  text-[12px] text-gray-800 leading-relaxed max-w-prose mx-auto ">
                  Our developers are equipped in building vigorous programming
                  liberated from any bugs.
                </p>
              </div>
            </div>
          </div>
      ...
      <div className=" flex justify-center py-10 bg-slate-200">
        <div className="lg:w-[90%] flex items-center lg:flex-row flex-col gap-10 px-2 ">
          <div className="flex flex-col gap-4">
            <span className="lg:text-[28px] font-[600] text-center lg:text-start">
              Hire developers and get the best of your idea
            </span>
            <p className=" text-center lg:text-start lg:text-[16px]  text-[12px]">
              Innovation drives change yet people develop values and get things
              going. Hire developers to Foster the right technical solution. To
              transform challenges into benefits one requires vision, a nitty
              gritty guide, and skilled. Hire highly-experienced developers on
              remote that grasps the center necessities of your business and is
              capable to fit the methodology and technique to meet your
              essential goals. The team will help you deliver the
              product/service to the market in the least time possible. When the
              best brains come together, they make the best product as well.
            </p>
          </div>
          <img
            alt=""
            src={img}
            className="lg:w-[600px] rounded-md  lg:h-[400px]"
          />
        </div>
      </div>

      {/* <div className=" flex  justify-center py-5">
        <div className=" lg:items-center flex flex-col gap-5 w-full px-2  lg:gap-10">
          ...
          <ul className="flex flex-col gap-10 ">
            <li className=" flex lg:space-x-20 flex-col gap-3 lg:flex-row">
              <li className="border lg:text-[20px] text-[16px] lg:w-[300px] border-black rounded-md text-gray-700 px-4 py-2 shadow-md">
            ...
            <li className=" flex lg:space-x-20 flex-col  gap-3 lg:flex-row">
              <li className="border lg:text-[20px] text-[16px] lg:w-[300px] whitespace-nowrap border-black rounded-md text-gray-700 px-4 py-2 shadow-md">
